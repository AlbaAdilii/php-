...
*/
   if ($_SESSION['is_admin'] == 'true') {
     ...
     $sql = "SELECT movies.movie_name, users.email, bookings.id, bookings.nr_tickets,
      bookings.date, bookings.is_approved, bookings.time FROM movies
    ...
    $bookings_data = $selectBookings->fetchAll();
      ...
      $sql = "SELECT movies.movie_name, users.email, bookings.nr_tickets, 
      bookings.date,bookings.is_approved, bookings.time
