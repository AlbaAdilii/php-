        ...
        <main class="col-md ms-sm-auto col-lg-10 px-md-4">
                ...
                <form action="addMovie.php" method="post">
                        <div class="form-floating">
                            <input type="text" class="form-control" id="floatingInput" placeholder="MovieName"
                            name="movie_name" >
                        ...
                        <div class="form-floating">
                            <input type="text" class="form-control" id="floatingInput" placeholder="MovieDescription"
                            name="movie_desc" >
                        ...
                        <div class="form-floating">
                            <input type="file" class="form-control" id="floatingInput" placeholder="MovieImage"
                            name="movie_image" >
